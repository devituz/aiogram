...
async def accept(cb: CallbackQuery):
    ...
    # 🔹 Qabul qilingandan keyin ham asosiy menyuga qaytish
    user_msg = await get_user_by_telegram_id(uid)
    # Agar user bot bilan chatda bo‘lsa:
    # await send_main_menu(user_msg)  # Agar Message obyektini saqlagan bo‘lsangiz
